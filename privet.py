...
with col1:
    kaz_button = st.button('Казахстан')

with col2:
    uzb_button = st.button('Узбекистан')

with col3:
    tjk_button = st.button('Таджикистан')

col4, col5 = st.sidebar.columns(2)
with col4:
    kgz_button = st.button('Кыргызстан')

with col5:
    all_countries_button = st.button('Общий график')
