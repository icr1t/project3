...
if bar_chart_button:
    ...
    st.write("Гистограмма показывает данные для следующих стран: Казахстан, Узбекистан, Таджикистан, Кыргызстан")
    st.write("Казахстан - Синий")
    st.write("Узбекистан - Зеленый")
    st.write("Таджикистан - Желтый")
    st.write("Кыргызстан - Красный")